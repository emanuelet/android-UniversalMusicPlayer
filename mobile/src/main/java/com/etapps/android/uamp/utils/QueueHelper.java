...
package com.etapps.android.uamp.utils;

import android.media.MediaMetadata;
import android.media.session.MediaSession;
import android.os.Bundle;

import com.etapps.android.uamp.VoiceSearchParams;
...
import static com.etapps.android.uamp.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_SEARCH;
...
public class QueueHelper {
    ...
    public static List<MediaSession.QueueItem> getPlayingQueueFromSearch(String query,
        ...
        if (params.isAny) {
            ...
            // for etapps, favorite playlists, "I'm feeling lucky", most recent, etc.
        ...
        // to Google, for etapps, but is not. For etapps, a user searching for Madonna on
        ...
        if (params.isUnstructured || result == null || !result.iterator().hasNext()) {
            // To keep it simple for this etapps, we do unstructured searches on the
